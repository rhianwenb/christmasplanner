      ...
      <div className="container mx-auto mt-20">
        <div className="grid sm:grid-cols-3 gap-16 justify-items-center">
          <div className="justify-items-center">
            <Link href={"/todos"} className="hover:underline"><h3 className="text-2xl text-red-800 font-bold"> Tasks for Santa </h3></Link>
          ...
          <div className="justify-items-center">
            <h3 className="text-2xl text-red-800 font-bold mb-2"> Countdown ... <em>tick tock!</em></h3>
          ...
          <div className="justify-items-center">
            <Link href={"/notes"} className="hover:underline"> <h3 className="text-2xl text-red-800 font-bold"> Food Is Love </h3> </Link>
